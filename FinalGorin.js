function setup() {
  ...
  colorMode(HSB);
  noStroke();
  circle1 = new Ellipse(300, 300, 400, 400, 0, 0, 0, 0, 0, 2, 225, 1, 100, 2);
  circle1.chapos = createVector(-2, -2);
  circle1.loopStyle = 1  // this is reset
  
  // dr. spell remix
 // Ellipse(x, y, wt, ht, hu, vx = 0, vy = 0,  tx = 0, ty = 0, chahu = 0, tarhu = 0, alph = 1.0, life = 100, loopStyle = 0) 
  //circle2 = new Ellipse(300, 300, 200, 200, 180, -2, -2, 0, 0, 0, 180 );
	//circle2.loopStyle = 0  // this in going to pingpong
...
function Ellipse(x, y, wt, ht, hu, vx = 0, vy = 0,  tx = 0, ty = 0, chahu = 0, tarhu = 0, alph = 1.0, life = 100, loopStyle = 0) {
  var PINGPONG = 0
  var RESET = 1
  var NOLOOP = 2
  ...
  this.display = function(){
    ...
    ellipse(this.currpos.x, this.currpos.y, this.wt, this.ht);
		}
}
